...
public class Actions {
    ...
    static public SequenceAction fadeIn () {
        AlphaAction action = action(AlphaAction.class);
        action.setAlpha(1);
        action.setDuration(1);
        return sequence(fadeOut(0), show(), action);
    }

    static public SequenceAction fadeOut () {
        AlphaAction action = action(AlphaAction.class);
        action.setAlpha(0);
        action.setDuration(1);
    ...
    static public SequenceAction hide (ArrayList<String> t){
        return new SequenceAction(hide());
    }

    static public SequenceAction left (ArrayList<String> t){
        return new SequenceAction(moveTo(75, -600));
    }

    static public SequenceAction right (ArrayList<String> t){
        return new SequenceAction(moveTo(800, -600));
    }

    static public SequenceAction middle (ArrayList<String> t){
        return new SequenceAction(moveTo(425, -600));
    }

    static public SequenceAction fullscreen (ArrayList<String> t){
        return new SequenceAction(moveTo(0, 0));
    }


    static public SequenceAction show (ArrayList<String> t){
        String var = t.get(0);
        ...
        switch (var) {
            case "left":
                return new SequenceAction(moveTo(75, -600), show());
            case "right":
                return new SequenceAction(moveTo(800, -600), show());
            case "middle":
                return new SequenceAction(moveTo(425, -600), show());
            case "fullscreen":
                return new SequenceAction(moveTo(0, 0), show());
        }

        return new SequenceAction(show());
...
//        for (String b: t){
//            t.remove(b);
//            Class x = Actions.class;
//            try {
//                Method m = x.getDeclaredMethod(b,cArg);
//                actions.add((Action) m.invoke(null));
...
//        }
//
//        Action[] actiond = new Action[actions.size()];
//        actiond = actions.toArray(actiond);
//        return new SequenceAction(actiond);
    }
