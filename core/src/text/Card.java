...
public class Card {
    ...
    public boolean send() {
        ...
        if (this.indentLevel > Vint.getCurrentScript().allowedLevel) {
            return false;
        }
        ...
        Vint.getCurrentScript().allowedLevel = this.indentLevel;
        //evaluates an if statement
        Vint.getCurrentScript().allowedLevel += CurrentCommand.getInstance().getLevelModifier();
